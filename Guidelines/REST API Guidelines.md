...
#### Endpoint 
An endpoint refers to the an interface through which users interact with the API. An endpoint is formed ot of the action, resource, and identifiers and parameters, if any.  An full API is composed of all the different endpoints.
...
### 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NjY3OTE1NjQsLTE1MzYyNjE4MTQsLT
