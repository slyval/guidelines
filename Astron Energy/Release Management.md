...
### Branching 
In order to manage the different stages that source code goes through from initial creation to deployment in production, th
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDcyMDM4MzJdfQ==
-->