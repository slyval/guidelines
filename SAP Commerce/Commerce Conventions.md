...
- If the data is created only once and rarely changes, consider adding it in the essentialdata-<name>.impex file under the resources/import
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4MTE4MjU4MywtMTY1Mzk2ODIyOSwtMT
